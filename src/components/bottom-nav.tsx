...
import { Home, Dumbbell, Library, Target, Plus, User } from "lucide-react";

// Accueil / Exercices / Collection / Objectif B1 / Ajouter (central) / Profil. Référence, Cas,
...
const ITEMS = [
  ...
  { href: "/objectif-b1", label: "Objectif B1", icon: Target },
